...
public class GetAllApi {
    ...
    public static void main(String[] args) throws IOException {
        getApi("get all captain ",
                new URL("https://expressapis.wedeliverspace.dev/api/v1/captain/get_all_captains"));
        getApi("get all teams ",
                new URL("https://expressapis.wedeliverspace.dev/api/v1/team/get_all_teams"));
        getApi("get team by id ",
                new URL("https://expressapis.wedeliverspace.dev/api/v1/team/get_team_by_id?team_id=1"));

        getApi("get abstract all captains",
                new URL("https://expressapis.wedeliverspace.dev/api/v1/captain/get_abstract_all_captains?team_id&search_txt=yaq"));
        getApi("get captain tracking ids",
                new URL("https://expressapis.wedeliverspace.dev/api/v1/captain/get_captain_tracking_ids?captain_id=22&tracking_id=T"));
    ...
    public static void getApi(String api_name, URL url) throws IOException {
